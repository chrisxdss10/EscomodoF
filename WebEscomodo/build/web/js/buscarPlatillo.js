...
//JQUERY    
        ...
        */
        $(document).on("click", ".add", function(){
            ...
            var target=$("#cart");
            var shake=true;
            var eltoDrag = $(this).closest(".card.small.sticky-action").find("img").eq(0);
            $.ajax({
                method: "post",
        ...
        $(document).on("click",".btn-flat.right.fav",function(){
            $.ajax({
                ...
                data: jQuery.param({ idP: $(this).attr("data-button-id"), currentClass: $(this).children("i").attr("class")}),
                success:function(resp){
                    var Jresp=$.parseJSON(resp);
